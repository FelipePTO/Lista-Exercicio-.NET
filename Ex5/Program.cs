...
namespace Ex4
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            imprimeDados(desenhoA);
            imprimeDados(desenhoB);
            imprimeDados(desenhoC);
            imprimeDados(desenhoD);
            imprimeDados(desenhoE);
            imprimeDados(desenhoF);
            imprimeDados(desenhoG);
            imprimeDados(desenhoH);
