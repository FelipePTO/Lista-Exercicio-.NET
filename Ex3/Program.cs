...
namespace Ex1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(desenhoA.FilhosEmOrdem());
            Console.WriteLine(desenhoB.FilhosEmOrdem());
            Console.WriteLine(desenhoC.FilhosEmOrdem());
            Console.WriteLine(desenhoD.FilhosEmOrdem());
            Console.WriteLine(desenhoE.FilhosEmOrdem());
            Console.WriteLine(desenhoF.FilhosEmOrdem());
            Console.WriteLine(desenhoG.FilhosEmOrdem());
            Console.WriteLine(desenhoH.FilhosEmOrdem());
